...
class TestWorld(unittest.TestCase):
    ...
    def test_reset(self):
        self.assertEqual(len(self.world.food_coordinates), 0)
        ...
        self.world.food_coordinates = [[0, 0, 0]]
        for index in range(self.array_size):
            self.world.data[index] = 99

        self.assertEqual(len(self.world.food_coordinates), 1)
    ...
    def test_move_ant(self):
        ...
        self.assertTrue(self.world.set(source_field))

        destination_field.ant_count = 0
        self.assertTrue(self.world.set(destination_field))
